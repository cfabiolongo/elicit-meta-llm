...
df = pd.read_excel('dataset/squad_dev_filtered_subset.xlsx')
...
results_bertscore = bertscore.compute(predictions=preds, references=dataset['answer_text'], model_type="microsoft/deberta-v2-xxlarge-mnli")
...
filename = f"squad_preds_metrics_t{temp}"
