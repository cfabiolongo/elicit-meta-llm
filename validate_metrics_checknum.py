...
# # Funzione per rimuovere caratteri superflui in mezzo ai numeri
# def rimuovi_caratteri_superflui(stringa):
#     # Utilizza una regex per mantenere solo i numeri
#     return re.sub(r'[^0-9]', '', stringa)
#
# # Funzione per verificare se la stringa è un numero valido
# def is_number(stringa):
#     return stringa.isdigit()
#
# # Funzione per trasformare un numero in una stringa di testo
# def numero_in_parola(numero):
#     return num2words(numero, lang='en')
#
# # Esempio di utilizzo
# input_stringa = "11,000 years BP"  # Stringa con caratteri superflui
# numero_pulito = rimuovi_caratteri_superflui(input_stringa)
#
# if is_number(numero_pulito):
#     parola = numero_in_parola(int(numero_pulito))
#     print(f"{input_stringa} ---> {parola}")
# else:
#     print(f"La stringa '{input_stringa}' non contiene un numero valido.")
